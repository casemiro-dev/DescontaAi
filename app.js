...
const MESSAGES = {
    500: `Verifiquei uma condição especial e consegui liberar uma redução no valor da sua fatura, ficando em {{valor}} por 6 meses, com renovação de fidelidade. É uma oportunidade de continuar conosco pagando menos; posso aplicar essa condição?`,
    1000: `Consegui verificar uma condição ainda melhor para você. Foi liberado o valor de {{valor}} por 6 meses, com renovação de fidelidade, garantindo uma economia na sua fatura durante esse período. Posso deixar essa condição ativa?`,
    1500: `Fiz uma nova verificação para tentar melhorar sua condição e consegui uma oferta especial: sua fatura pode ficar em {{valor}} por 6 meses, com renovação de fidelidade. Assim, você consegue reduzir seu custo mensal e continuar aproveitando o serviço. Podemos fechar dessa forma?`,
    2000: `Consegui uma condição diferenciada após verificar as possibilidades disponíveis. Sua fatura pode ficar em {{valor}} por 6 meses, com renovação de fidelidade. É uma oportunidade de reduzir bastante o valor mensal sem precisar cancelar o serviço. Você gostaria que eu aplicasse essa condição?`,
    2500: `Para tentar resolver da melhor forma possível, verifiquei uma condição especial com a supervisão e consegui liberar sua fatura por {{valor}} durante 6 meses, com renovação de fidelidade. Dessa forma, você consegue uma redução importante no valor e mantém seu serviço conosco. Podemos aproveitar essa condição?`,
    3000: `Fiz o possível para encontrar a melhor condição disponível e consegui uma oferta especial para sua permanência conosco: {{valor}} por 6 meses, com renovação de fidelidade. É a melhor condição que consegui liberar para reduzir seu valor mensal e evitar o cancelamento. Posso aplicar essa oferta?`
};
